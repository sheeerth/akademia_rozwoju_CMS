...
const Newsletter = () => {
    ...
    const form = submitted ? (<div className="min-w-max font-medium items-center flex"><p className="my-auto text-center bg-blue p-4 rounded-lg text-white"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 mx-auto mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
